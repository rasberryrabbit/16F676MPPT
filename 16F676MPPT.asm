...
L__main77:
	BTFSC      STATUS+0, 0
	GOTO       L__main55
;16F676MPPT.mpas,228 :: 		LED1_tm:=150;
	MOVLW      150
	MOVWF      _LED1_tm+0
;16F676MPPT.mpas,229 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
;16F676MPPT.mpas,230 :: 		end else
	GOTO       L__main56
L__main55:
;16F676MPPT.mpas,231 :: 		LED1_tm:=200;
	MOVLW      200
	MOVWF      _LED1_tm+0
L__main56:
;16F676MPPT.mpas,232 :: 		if (adc_vol+vol_prev2+1) div 2 < vol_prev1 then begin
	MOVF       _vol_prev2+0, 0
	ADDWF      _adc_vol+0, 0
	MOVWF      R0+0
	MOVF       _adc_vol+1, 0
...
L__main78:
	BTFSC      STATUS+0, 0
	GOTO       L__main58
;16F676MPPT.mpas,233 :: 		flag_inc:=true;
	MOVLW      255
	MOVWF      _flag_inc+0
;16F676MPPT.mpas,234 :: 		end;
L__main58:
;16F676MPPT.mpas,235 :: 		end else begin
	GOTO       L__main50
L__main49:
;16F676MPPT.mpas,236 :: 		LED1_tm:=100;
	MOVLW      100
	MOVWF      _LED1_tm+0
;16F676MPPT.mpas,237 :: 		VOLPWM:=PWM_MID;
	MOVLW      115
	MOVWF      _VOLPWM+0
;16F676MPPT.mpas,238 :: 		flag_inc:=false;
	CLRF       _flag_inc+0
;16F676MPPT.mpas,239 :: 		power_curr:=0;
	CLRF       _power_curr+0
	CLRF       _power_curr+1
	CLRF       _power_curr+2
	CLRF       _power_curr+3
;16F676MPPT.mpas,240 :: 		adc_cur:=0;
	CLRF       _adc_cur+0
	CLRF       _adc_cur+1
;16F676MPPT.mpas,241 :: 		goto CONTLOOP;
	GOTO       L__main_CONTLOOP
;16F676MPPT.mpas,242 :: 		end;
L__main50:
;16F676MPPT.mpas,245 :: 		if flag_inc then begin
	MOVF       _flag_inc+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main61
;16F676MPPT.mpas,246 :: 		if VOLPWM<PWM_MAX then
	MOVLW      240
	SUBWF      _VOLPWM+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main64
;16F676MPPT.mpas,247 :: 		Inc(VOLPWM)
	INCF       _VOLPWM+0, 1
	GOTO       L__main65
;16F676MPPT.mpas,248 :: 		else begin
L__main64:
;16F676MPPT.mpas,249 :: 		VOLPWM:=PWM_MAX;
	MOVLW      240
	MOVWF      _VOLPWM+0
;16F676MPPT.mpas,250 :: 		flag_inc:=false;
	CLRF       _flag_inc+0
;16F676MPPT.mpas,251 :: 		end;
L__main65:
;16F676MPPT.mpas,252 :: 		end else begin
	GOTO       L__main62
L__main61:
;16F676MPPT.mpas,253 :: 		if VOLPWM>PWM_MIN then
	MOVF       _VOLPWM+0, 0
	SUBLW      1
	BTFSC      STATUS+0, 0
	GOTO       L__main67
;16F676MPPT.mpas,254 :: 		Dec(VOLPWM)
	DECF       _VOLPWM+0, 1
	GOTO       L__main68
;16F676MPPT.mpas,255 :: 		else begin
L__main67:
;16F676MPPT.mpas,256 :: 		VOLPWM:=PWM_MIN;
	MOVLW      1
	MOVWF      _VOLPWM+0
;16F676MPPT.mpas,257 :: 		flag_inc:=true;
	MOVLW      255
	MOVWF      _flag_inc+0
;16F676MPPT.mpas,258 :: 		end;
L__main68:
;16F676MPPT.mpas,259 :: 		end;
L__main62:
;16F676MPPT.mpas,260 :: 		CONTLOOP:
L__main_CONTLOOP:
