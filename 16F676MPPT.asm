...
;16F676MPPT.mpas,218 :: 		power_curr:= dword(adc_vol * adc_cur);
	...
	MOVF       R0+3, 0
	MOVWF      _power_curr+3
;16F676MPPT.mpas,221 :: 		wtmp:=TICK_1000;
	MOVF       _TICK_1000+0, 0
	MOVWF      _wtmp+0
	MOVF       _TICK_1000+1, 0
	MOVWF      _wtmp+1
;16F676MPPT.mpas,222 :: 		if ON_PWM>PWM_MID then begin
	MOVF       _ON_PWM+0, 0
	SUBLW      120
	BTFSC      STATUS+0, 0
	GOTO       L__main46
;16F676MPPT.mpas,223 :: 		if wtmp - voltime > _PWM_CHECK then begin
	MOVF       _voltime+0, 0
	SUBWF      _wtmp+0, 0
	MOVWF      R1+0
	MOVF       _voltime+1, 0
...
L__main75:
	BTFSC      STATUS+0, 0
	GOTO       L__main49
;16F676MPPT.mpas,224 :: 		voltime:=wtmp;
	MOVF       _wtmp+0, 0
	MOVWF      _voltime+0
	MOVF       _wtmp+1, 0
	MOVWF      _voltime+1
;16F676MPPT.mpas,225 :: 		adc_cur:=LM358_diff;
	MOVF       _LM358_diff+0, 0
	MOVWF      _adc_cur+0
	CLRF       _adc_cur+1
;16F676MPPT.mpas,226 :: 		end;
L__main49:
;16F676MPPT.mpas,227 :: 		end else
	GOTO       L__main47
L__main46:
;16F676MPPT.mpas,228 :: 		voltime:=wtmp;
	MOVF       _wtmp+0, 0
	MOVWF      _voltime+0
	MOVF       _wtmp+1, 0
	MOVWF      _voltime+1
L__main47:
;16F676MPPT.mpas,230 :: 		if adc_cur>LM358_diff then begin
	MOVF       _adc_cur+1, 0
	SUBLW      0
	BTFSS      STATUS+0, 2
	GOTO       L__main76
...
L__main77:
	BTFSS      STATUS+0, 2
	GOTO       L__main55
;16F676MPPT.mpas,233 :: 		LED1_tm:=250;
	MOVLW      250
	MOVWF      _LED1_tm+0
;16F676MPPT.mpas,234 :: 		goto CONTLOOP;
	GOTO       L__main_CONTLOOP
;16F676MPPT.mpas,235 :: 		end else if power_curr < power_prev then begin
L__main55:
...
L__main78:
	BTFSC      STATUS+0, 0
	GOTO       L__main58
;16F676MPPT.mpas,236 :: 		LED1_tm:=150;
	MOVLW      150
	MOVWF      _LED1_tm+0
;16F676MPPT.mpas,237 :: 		flag_inc:=not flag_inc;
	COMF       _flag_inc+0, 1
;16F676MPPT.mpas,238 :: 		end else
	GOTO       L__main59
L__main58:
;16F676MPPT.mpas,239 :: 		LED1_tm:=200;
	MOVLW      200
	MOVWF      _LED1_tm+0
L__main59:
;16F676MPPT.mpas,245 :: 		end else begin
	GOTO       L__main53
L__main52:
;16F676MPPT.mpas,246 :: 		LED1_tm:=100;
	MOVLW      100
	MOVWF      _LED1_tm+0
;16F676MPPT.mpas,247 :: 		VOLPWM:=PWM_MIN;
	MOVLW      10
	MOVWF      _VOLPWM+0
;16F676MPPT.mpas,248 :: 		flag_inc:=True;
	MOVLW      255
	MOVWF      _flag_inc+0
;16F676MPPT.mpas,249 :: 		power_curr:=0;
	CLRF       _power_curr+0
	CLRF       _power_curr+1
	CLRF       _power_curr+2
	CLRF       _power_curr+3
;16F676MPPT.mpas,250 :: 		adc_cur:=0;
	CLRF       _adc_cur+0
	CLRF       _adc_cur+1
;16F676MPPT.mpas,251 :: 		goto CONTLOOP;
	GOTO       L__main_CONTLOOP
;16F676MPPT.mpas,252 :: 		end;
L__main53:
;16F676MPPT.mpas,255 :: 		if flag_inc then begin
	MOVF       _flag_inc+0, 0
	BTFSC      STATUS+0, 2
	GOTO       L__main61
;16F676MPPT.mpas,256 :: 		if VOLPWM<PWM_MAX then
	MOVLW      250
	SUBWF      _VOLPWM+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L__main64
;16F676MPPT.mpas,257 :: 		Inc(VOLPWM)
	INCF       _VOLPWM+0, 1
	GOTO       L__main65
;16F676MPPT.mpas,258 :: 		else begin
L__main64:
;16F676MPPT.mpas,259 :: 		VOLPWM:=PWM_MAX;
	MOVLW      250
	MOVWF      _VOLPWM+0
;16F676MPPT.mpas,260 :: 		flag_inc:=false;
	CLRF       _flag_inc+0
;16F676MPPT.mpas,261 :: 		end;
L__main65:
;16F676MPPT.mpas,262 :: 		end else begin
	GOTO       L__main62
L__main61:
;16F676MPPT.mpas,263 :: 		if VOLPWM>PWM_MIN then
	MOVF       _VOLPWM+0, 0
	SUBLW      10
	BTFSC      STATUS+0, 0
	GOTO       L__main67
;16F676MPPT.mpas,264 :: 		Dec(VOLPWM)
	DECF       _VOLPWM+0, 1
	GOTO       L__main68
;16F676MPPT.mpas,265 :: 		else begin
L__main67:
;16F676MPPT.mpas,266 :: 		VOLPWM:=PWM_MIN;
	MOVLW      10
	MOVWF      _VOLPWM+0
;16F676MPPT.mpas,267 :: 		flag_inc:=true;
	MOVLW      255
	MOVWF      _flag_inc+0
...
L__main62:
;16F676MPPT.mpas,270 :: 		CONTLOOP:
L__main_CONTLOOP:
;16F676MPPT.mpas,272 :: 		end;
	GOTO       L__main22
